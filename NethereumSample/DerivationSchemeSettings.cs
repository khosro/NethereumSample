...
namespace NethereumSample
{
    ...
    {
        public static DerivationSchemeSettings Parse(string derivationStrategy, Network network)
        {
            if (network == null)
                throw new ArgumentNullException(nameof(network));
            if (derivationStrategy == null)
                throw new ArgumentNullException(nameof(derivationStrategy));
            var result = new NBXplorer.DerivationStrategy.DerivationStrategyFactory(network).Parse(derivationStrategy);
        ...
        public DerivationSchemeSettings(DerivationStrategyBase derivationStrategy, Network network)
        {
            if (network == null)
                throw new ArgumentNullException(nameof(network));
            if (derivationStrategy == null)
        ...
        public BitcoinExtPubKey AccountKey
        {
            get
            {
                return ExplicitAccountKey ?? new BitcoinExtPubKey(AccountDerivation.GetExtPubKeys().First(), Network);
            }
        }
        ...
        public AccountKeySettings[] AccountKeySettings
        {
            get
            {
                ...
                if (_AccountKeySettings == null)
                {
                    ...
                    {
                        AccountKey = e.GetWif(this.Network),
                    }).ToArray();
