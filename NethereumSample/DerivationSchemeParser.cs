...
namespace NethereumSample
{
    ...
    public class DerivationSchemeParser
    {
        ...
        public Dictionary<uint, DerivationType> ElectrumMappingDerivationType = new Dictionary<uint, DerivationType>();

        public Script HintScriptPubKey { get; set; }

        Dictionary<uint, string[]> ElectrumMapping = new Dictionary<uint, string[]>();

        public DerivationSchemeParser(Network expectedNetwork, Dictionary<uint, DerivationType> electrumMappingDerivationType = null)
        {
            if (expectedNetwork == null)
                throw new ArgumentNullException(nameof(expectedNetwork));
            Network = expectedNetwork;
            if (ElectrumMappingDerivationType == null)
                ElectrumMappingDerivationType = new Dictionary<uint, DerivationType>();
            else
                ElectrumMappingDerivationType = electrumMappingDerivationType;
        }
